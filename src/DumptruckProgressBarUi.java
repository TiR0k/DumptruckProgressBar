...
public class DumptruckProgressBarUi extends BasicProgressBarUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new DumptruckProgressBarUi();
    }
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) DumptruckIcons.TRUCK_ICON) : ((ScalableIcon) DumptruckIcons.RTRUCK_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        DumptruckIcons.TRUCK_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
